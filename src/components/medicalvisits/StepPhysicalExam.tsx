      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Textarea
            ...
            placeholder="Résultats de l'examen visuel..."
            rows={2}
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            onChange={handleInputChange}
            placeholder="Résultats de l'examen auditif..."
            rows={2}
            className="resize-none"
          />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Textarea
            ...
            onChange={handleInputChange}
            placeholder="Évaluation respiratoire..."
            rows={2}
            className="resize-none"
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            onChange={handleInputChange}
            placeholder="Évaluation cardiovasculaire..."
            rows={2}
            className="resize-none"
          />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Textarea
            ...
            onChange={handleInputChange}
            placeholder="Évaluation musculo-squelettique..."
            rows={2}
            className="resize-none"
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            onChange={handleInputChange}
            placeholder="Évaluation neurologique..."
            rows={2}
            className="resize-none"
          />
        </div>
      ...
      <div className="border-t pt-4 mt-4">
        ...
        <div className="space-y-2 mb-4">
          ...
          <Textarea
            ...
            onChange={handleInputChange}
            placeholder="Restrictions liées au travail..."
            rows={2}
            className="resize-none"
          />
        </div>
        ...
        <div className="space-y-2 mb-4">
          ...
          <Textarea
            ...
            onChange={handleInputChange}
            placeholder="Recommandations pour le travailleur..."
            rows={2}
            className="resize-none"
          />
        </div>
