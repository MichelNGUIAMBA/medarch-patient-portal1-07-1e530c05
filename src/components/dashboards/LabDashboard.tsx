...
const LabDashboard = () => {
  return <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatsCard title="Examens en attente" value={14} icon={ClipboardCheck} iconColor="text-orange-600" />
        <StatsCard title="Examens réalisés aujourd'hui" value={23} icon={ClipboardCheck} iconColor="text-green-600" />
      </div>
        ...
        <div className="p-0">
          <table className="w-full">
            ...
            <tbody>
              ...
              date: "24/04/2023"
            }].map(exam => <tr key={exam.id} className="border-b hover:bg-gray-50">
