...
const QuickActions = () => {
  ...
  return <div className="rounded-lg shadow p-6 bg-inherit">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Button variant="outline" onClick={() => navigate('/dashboard/new-patient')} className="h-auto py-6 flex flex-col items-center justify-center hover:border-blue-200 transition-colors text-base text-inherit bg-inherit">
