    ...
    <div className="container mx-auto py-6">
          ...
          <CardContent>
            <dl className="grid grid-cols-3 gap-4">
              <div className="space-y-1">
                <dt className="text-sm font-medium text-gray-500">ID Employé</dt>
              ...
              <div className="space-y-1">
                ...
                <dd>{patient.gender === 'M' ? 'Masculin' : 'Féminin'}</dd>
              </div>
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                <dt className="text-sm font-medium text-gray-500">Enregistré le</dt>
        ...
        <Card>
          ...
          <CardContent>
            <dl className="grid grid-cols-1 gap-4">
              <div className="space-y-1">
                <dt className="text-sm font-medium text-gray-500">Type de service</dt>
                <dd className={getServiceColor(patient.service)}>{getServiceName(patient.service)}</dd>
              </div>
              <div className="space-y-1">
                <dt className="text-sm font-medium text-gray-500">Pris en charge par</dt>
                <dd>{patient.takenCareBy?.name || 'Non pris en charge'}</dd>
              </div>
              <div className="space-y-1">
                <dt className="text-sm font-medium text-gray-500">Notes</dt>
                <dd className="border p-3 rounded-md bg-gray-50 min-h-[100px]">
      ...
      <div className="flex flex-col lg:flex-row gap-4 mb-6">
        ...
        >
          ...
          Modifier le {getServiceName(patient.service).toLowerCase()}
        </Button>
