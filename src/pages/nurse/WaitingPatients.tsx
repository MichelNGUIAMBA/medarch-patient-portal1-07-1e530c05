...
const WaitingPatients = () => {
  ...
  patient.name.toLowerCase().includes(searchTerm.toLowerCase()) || patient.id.toLowerCase().includes(searchTerm.toLowerCase())) && (
  // Filtrer par service
  serviceFilter === 'all' || patient.service === serviceFilter)).sort((a, b) => {
      ...
      <div className="rounded-lg shadow p-6 bg-slate-950">
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <div className="relative flex-grow">
            ...
            <Input placeholder="Rechercher un patient..." className="pl-10" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} />
          </div>
